  ...
  "pages":[
    {
      ...
      "elements":[
        ...
        {"type":"rating","name":"appearance_impact","visibleIf":"{appearance_enable} = true","title":"Your hero(ine)'s appearance impacts their experience in the story.","isRequired":true,"requiredIf":"{appearance_enable} = true","rateMax":7,"minRateDescription":"Strongly disagree","maxRateDescription":"Strongly agree"},
        {"type":"rating","name":"appearance_aware","visibleIf":"{appearance_enable} = true","title":"Your hero(ine)' is aware of the effects of their appearance.","isRequired":true,"requiredIf":"{appearance_enable} = true","rateMax":7,"minRateDescription":"Strongly disagree","maxRateDescription":"Strongly agree"}],
        "title":"Appearance"
      },{
        ...
        "name":"Personality traits","elements":[
          ...
          {"type":"rating","name":"personality_wellrounded","title":"Your hero(ine) is well_rounded.","isRequired":true,"rateMax":7,"minRateDescription":"Strongly disagree","maxRateDescription":"Strongly agree"},
