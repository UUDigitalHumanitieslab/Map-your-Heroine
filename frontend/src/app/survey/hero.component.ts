...
import {
    YESNOUNK_OPTIONS, YESNO_OPTIONS, ROLE_OPTIONS,
    EDUCATION_OPTIONS, PETS_OPTIONS, AGE_OPTIONS, GENDER_OPTIONS,
    RELATIVES_OPTIONS, WEALTH_OPTIONS, PROBLEM_OPTIONS, SOLUTION_OPTIONS
} from '../models/hero';
...
export class HeroComponent implements OnInit {
    ...
    onSubmit() {
        ...
        this.backend.post('heroes', heroFormData as IHero).subscribe({
            next: newHero => this.addHero.emit(newHero),
            error: errorResponse => {
